...
export function Today({ onAuthError }: TodayProps) {
  ...
  if (error) {
    return (
      <div className="page page-center text-slate-100">
        <div className="surface w-full rounded-[1.75rem] px-8 py-10">
  ...
  return (
    <div className="page text-slate-100">
      <header className="animate-rise mb-6 flex items-end justify-between gap-3">
        <div className="min-w-0">
          <p className="eyebrow">Today</p>
          <p className="mt-1.5 truncate text-[15px] font-medium text-slate-300">
      ...
      {showCategoryBreakdown && (
        <div className="surface animate-rise-delay-2 mt-4 rounded-[1.75rem] p-4 sm:p-5">
          <div className="flex items-center justify-between gap-2">
            <p className="eyebrow">Breakdown</p>
            <p className="text-[11px] text-slate-500">{categories.length} categories</p>
          </div>
          <div className="mt-4 flex h-3 overflow-hidden rounded-full bg-white/[0.04] ring-1 ring-white/[0.04]">
              ...
              return (
                ...
                >
                  ...
                  <div className="min-w-0 flex-1">
                    <p className="truncate text-[13px] font-medium text-slate-200">{cat.categoryName}</p>
      ...
      <div className="surface animate-rise-delay-2 mt-4 rounded-[1.75rem] p-4 sm:p-5">
        ...
        <div className="mt-3">
          ...
          {apps.map((app, index) => {
            ...
            return (
              <div key={app.exe} className="row-tap rounded-2xl px-1.5 py-3.5">
                ...
                <div className="ml-9.5 h-1.5 overflow-hidden rounded-full bg-white/[0.04]" style={{ marginLeft: "2.35rem" }}>
                  <div
...
function TodayHero({ total, limitMinutes }: { total: number; limitMinutes: number | null }) {
  if (limitMinutes === null) {
    return (
      <div className="surface overflow-hidden rounded-[1.75rem] px-5 py-9 text-center sm:px-6 sm:py-10">
        ...
        <p className="display-num relative mt-3 text-[3.25rem] font-bold leading-none tracking-tight min-[380px]:text-[3.75rem]">
          {formatDuration(total)}
        </p>
        <p className="relative mt-3 text-sm text-slate-500">focused screen time so far today</p>
  ...
  return (
    <div className="surface overflow-hidden rounded-[1.75rem] px-5 py-7 sm:px-6 sm:py-8">
      ...
      <div className="relative mx-auto h-[176px] w-[176px] min-[380px]:h-[188px] min-[380px]:w-[188px]">
        <svg
          viewBox="0 0 160 160"
        ...
        <div className="absolute inset-0 flex flex-col items-center justify-center px-2">
          <p className={`text-[2.1rem] font-bold leading-none min-[380px]:text-[2.35rem] ${over ? "display-num-warn" : "display-num"}`}>
            {formatDuration(total)}
          </p>
      ...
      <div className="relative mt-5 grid grid-cols-2 gap-2">
        <div className="rounded-2xl bg-white/[0.03] px-3 py-3.5 text-center ring-1 ring-white/[0.04]">
          ...
          <p className="num mt-1 text-[15px] font-semibold text-slate-200">
        ...
        <div className="rounded-2xl bg-white/[0.03] px-3 py-3.5 text-center ring-1 ring-white/[0.04]">
          ...
          <p className={`num mt-1 text-[15px] font-semibold ${over ? "text-amber-300" : "text-slate-200"}`}>
